...
### PLAYERS TABLE =============================================================================================
CREATE TABLE dim_nfl_players (player_id VARCHAR(12) PRIMARY KEY,
...
ON dim_nfl_players(first_name, last_name, birth_day);
...
#DROP TABLE dim_nfl_players;

### GAMES TABLE ==================================================================================================
CREATE TABLE dim_nfl_games (game_id VARCHAR(12) PRIMARY KEY ,
    home VARCHAR(3),
    away VARCHAR(3),
	home_score FLOAT,
    away_score FLOAT,
...
CREATE TABLE fact_nfl_performance ( 
...
# DELETE FROM fact_nfl_performance;
